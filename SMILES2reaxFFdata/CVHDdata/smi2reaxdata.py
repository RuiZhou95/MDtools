...
if __name__ == "__main__":
    ...
    smiles_list = ["O=C(CCCCCC)OCC(COC(CCCC)=O)(COC(CCCCCC)=O)COC(CCCC)=O", "CC(C)(C)CC(C)(C)C1=CC=C(NC2=CC=C(C(C)(C)CC(C)(C)C)C=C2)C=C1", "O=O"]  # ester and O2
    counts = [5, 5, 100]  # 50 esters, 2 O2 
